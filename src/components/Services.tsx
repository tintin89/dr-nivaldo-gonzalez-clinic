  ...
  const services = [
    {
      ...
      features: ["Cognitive Behavioral Therapy", "Trauma-Informed Care", "Solution-Focused Therapy"]
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      features: ["Relationship Building", "Communication Skills", "Conflict Resolution"]
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      features: ["Family Dynamics", "Parenting Support", "Teen Counseling"]
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      features: ["Anxiety Support Groups", "Depression Recovery", "Addiction Recovery"]
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      features: ["Anxiety Disorders", "Panic Attacks", "Phobias"]    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: t('services.depression.desc'),
      features: ["Depression Treatment", "Mood Disorders", "Behavioral Therapy"]
    }
  ]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="card group hover:border-primary-200">
